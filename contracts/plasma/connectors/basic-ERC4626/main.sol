...
abstract contract BasicConnector is Events, DSMath, Basic {
        ...
        returns (string memory _eventName, bytes memory _eventParam)
    {
        ...
        uint256 _sharesReceieved = vaultTokenContract.deposit(
            _underlyingAmt,
            address(this)
        );
        ...
        returns (string memory _eventName, bytes memory _eventParam)
    {
        ...
        uint256 _tokensDeposited = vaultTokenContract.mint(
            _shareAmt,
            address(this)
        );
        ...
        returns (string memory _eventName, bytes memory _eventParam)
    {
        ...
        uint256 _sharesBurned = vaultTokenContract.withdraw(
            _underlyingAmt,
            to,
            address(this)
        );
        ...
        returns (string memory _eventName, bytes memory _eventParam)
    {
        ...
        uint256 _underlyingAmtReceieved = vaultTokenContract.redeem(
            _shareAmt,
            to,
            address(this)
        );
...
contract ConnectV2BasicERC4626Plasma is BasicConnector {
