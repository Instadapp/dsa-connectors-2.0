...
abstract contract KyberResolver is Helpers {
    /**
     * @dev Sell XPL/ERC20_Token using KyberSwap.
     * @notice Swap tokens from exchanges like kyber, 0x etc, with calculation done off-chain.
     * @param buyAddr The address of the token to buy.(For XPL: 0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE)
     * @param sellAddr The address of the token to sell.(For XPL: 0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE)
...
contract ConnectV2KyberAggregatorPlasma is KyberResolver {
