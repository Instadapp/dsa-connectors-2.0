...
contract LiquidityResolver is Stores, Variables, Events {
        ...
        returns (string memory _eventName, bytes memory _eventParam)
    {
        ...
        (string[] memory _targets, bytes[] memory callDatas) = abi.decode(
            data,
            (string[], bytes[])
        );
...
contract ConnectV2InstaPoolV5Plasma is LiquidityResolver {
    string public constant name = "Instapool-v5";
}
