...
abstract contract CompoundBlueConnectors is Helpers, Events {
...
contract ConnectV2CompoundBluePolygon is CompoundBlueConnectors {
    string public constant name = "Compound-Blue-v1.0";
}
