...
abstract contract KyberResolver is Helpers {
    /**
     * @dev Sell BNB/ERC20_Token using KyberSwap.
     * @notice Swap tokens from exchanges like kyber, 0x etc, with calculation done off-chain.
     * @param buyAddr The address of the token to buy.(For BNB: 0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE)
     * @param sellAddr The address of the token to sell.(For BNB: 0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE)
...
contract ConnectV2KyberAggregatorBSC is KyberResolver {
