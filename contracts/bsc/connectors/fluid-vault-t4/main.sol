...
abstract contract FluidVaultT4Connector is Helpers, Events {
        ...
        returns (string memory _eventName, bytes memory _eventParam)
    {
        ...
        if (helper_.newColToken0 > 0) {
            ...
            (internalVar_.bnbAmount, helper_.newColToken0) = _handleDeposit(
                HandleDepositData({
                    isBnb: vaultT4Details_.supplyToken.token0 == getBnbAddr(),
        ...
        if (helper_.newColToken1 > 0) {
            ...
            (internalVar_.bnbAmount, helper_.newColToken1) = _handleDeposit(
                HandleDepositData({
                    isBnb: vaultT4Details_.supplyToken.token1 == getBnbAddr(),
        ...
        if (helper_.newDebtToken0 < 0) {
            internalVar_.bnbAmount = _handlePayback(
                HandlePaybackData({
                    isBnb: vaultT4Details_.borrowToken.token0 == getBnbAddr(),
                    isMin: false,
        ...
        if (helper_.newDebtToken1 < 0) {
            internalVar_.bnbAmount = _handlePayback(
                HandlePaybackData({
                    isBnb: vaultT4Details_.borrowToken.token1 == getBnbAddr(),
                    isMin: false,
        ...
        ) = vaultT4_.operate{value: internalVar_.bnbAmount}(
            helper_.nftId,
            helper_.newColToken0,
            helper_.newColToken1,
        ...
        returns (string memory _eventName, bytes memory _eventParam)
    {
        ...
        internalVar_.isDebtToken0Bnb =
            vaultT4Details_.borrowToken.token0 == getBnbAddr();
        internalVar_.isDebtToken1Bnb =
            vaultT4Details_.borrowToken.token1 == getBnbAddr();
...
contract ConnectV2FluidVaultT4BSC is FluidVaultT4Connector {
